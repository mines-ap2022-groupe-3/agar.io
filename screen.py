...
def draw_map(screen, position, tile_size=TILE_SIZE):
    ...
    first_square_left = int(max(0, ut.round_to(display_rect.left, tile_size)))
    first_square_top = int(max(0, ut.round_to(display_rect.top, tile_size)))
